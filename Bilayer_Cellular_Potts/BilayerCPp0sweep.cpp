//Here we run a parameter sweep on shape index
...
if (argc > 3) {infile = argv[1]; pfile = argv[2]; tindx = argv[3];} 
...
double Prange1[nall] = {113, 121, 130, 134, 138, 142, 146, 150, 154, 162, 178, 194 }; 
       
double Prange2[nall] = {113, 121, 130, 134, 138, 142, 146, 150, 154, 162, 178, 194 };
...
string et1, et2, et3, et4, et5, et6, et7, et8, pnot;

int nswp = 12;

string Pname[nswp] = {"p0_3p5", "p0_3p75", "p0_4", "p0_4p12", "p0_4p25", "p0_4p37", "p0_4p5", "p0_4p62", "p0_4p75", "p0_5p0", "p0_5p5", "p0_6"};
...
celsdat1[i].lay = 1; 
celsdat1[i].CPsetall(lamsa[0], areaf1[i-1], lamsp[0], Prange1[swp], eps[0], Bipara, laac[0], mac[0]);

celsdat2[i].lay = 2; 
celsdat2[i].CPsetall(lamsa[1], areaf2[i-1], lamsp[1], Prange2[swp], eps[1], Bipara, laac[1], mac[1]); 
...
et5 = to_string(lamsp[0]); et6 = to_string(Prange1[1]);
et7 = to_string(Prange2[1]); et8 = Bilabel;  
