...
int i=0, j=0,nall,ncells,confchk, latchk, nx;
...
double areaf1[nall], areaf2[nall];
...
double Perimavg = 0, Edgematavg = 0, Matchperiratio = 0, Horder1=0, Horder2=0;
int freq;
inindx >> words >> freq;
...
CPedgealghexK(pnts2, pnts1, gd2, celsdat2,celsdat1, Hlay1, T,Latt, nei2);
