...
//This one is aimed at capturing the oscillatory motion seen in CFC
...
int biswitch = 0;
double match = 0.8, checkmtch1=0, checkmtch2 = 0, checkrangelow, checkrangehi;
...
Perimavg = 0; Edgematavg = 0; Matchperiratio = 0;
	...
	{ 				// The pixel loop
		...
		if (biswitch == 0)
		{
			...
			checkmtch1 = regionbimatchpointy(pnts1,nei1, midbound,hibound);

			checkmtch2 = regionbimatchpointy(pnts2,nei2,midbound,hibound);


		if ((checkmtch1>=match) && (checkmtch2 >=match)) 
		{
