...
double switchlen1 = Peris1[1]/M_PI, switchlen2 = Peris2[1]/M_PI, lowbound = centery - 2*switchlen1, midbound = centery-switchlen1, hibound = centery + switchlen1, outbound = centery+2*switchlen1, midboundold = midbound, hiboundold = hibound;
...
setbendingpointysharp(pnts1, ns, midbound, hibound,Bipara);
setbendingpointysharp(pnts2, ns, midbound, hibound,Bipara);
...
Perimavg = 0; Edgematavg = 0; Matchperiratio = 0;
	...
	{ 				// The pixel loop
		...
		if (biswitch == 0)
		{
			...
			checkmtch1 = newregionbimatchpointy(pnts1,nei1, midbound,midboundold,hiboundold,hibound);

			checkmtch2 = newregionbimatchpointy(pnts2,nei2,midbound,midboundold,hiboundold,hibound);
			}
