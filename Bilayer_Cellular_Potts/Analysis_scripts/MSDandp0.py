...
neiseeds.time, neiseeds.neichg1, neiseeds.neichg2, neiseeds.neichg12,neiseeds.neichgsum,neiseeds.neichgtotseed, neiseeds.neichgtot,neiseeds.neichgavg,neiseeds.neichgstd, neiseeds.name = ed.getallneighdata(nlines,plen,nseeds,bilen,pval,snum,Bi,"neighchanges.dat")
...
figloop = msd.plotmsdr(mobility,plen,0,figloop,"<|R^{2} |>", pval2,endtime)
